...
class NuclearUI(customtkinter.CTk):
    def __init__(self, l1, l2, l3, l4, ud):
        ...
        self.button_lab1 = customtkinter.CTkButton(self, text="Lab1", font=("Lexend", 40, "bold"), height=150,
                                                   command=l1)
        self.button_lab1.grid(row=0, column=1)
        self.button_lab2 = customtkinter.CTkButton(self, text="Lab2", font=("Lexend", 40, "bold"), height=150,
                                                   command=l2)
        self.button_lab2.grid(row=0, column=2)
        self.button_lab3 = customtkinter.CTkButton(self, text="Lab3", font=("Lexend", 40, "bold"), height=150,
                                                   command=l3)
        self.button_lab3.grid(row=0, column=3)
        self.button_lab4 = customtkinter.CTkButton(self, text="Lab4", font=("Lexend", 40, "bold"), height=150,
                                                   command=l4)
